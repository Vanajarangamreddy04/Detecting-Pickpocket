...
main = tkinter.Tk()
main.title("Catch Me If You Can:Detecting Pickpocket Suspects from Large-Scale Public Transit Records") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Catch Me If You Can: Detecting Pickpocket Suspects from Large-Scale Public Transit Records')
